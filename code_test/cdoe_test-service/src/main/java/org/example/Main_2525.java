...
public class Main_2525 {
    public static void main(String[] args) {
        ...
        String setTimeOne = sc.nextLine();
        int setTimeTwo = sc.nextInt();

        String[] timeArray = setTimeOne.split(" ");
        String hour = null;
        String minutes = null;
        ...
        String parseResult = setDateStringPlusMin(timeResult, setTimeTwo);
    ...
    public static String setDateStringPlusMin(String timeA, long minutes){
        //Formatter
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyyMMddHHmmss");
        LocalDateTime localA = LocalDateTime.parse(timeA, formatter);
        localA = localA.plusMinutes(minutes);
